  ...
  <div class="single-post-container">
    <div class="container">
      ...
      <div class="single-post card">
                ...
                <div class="card-body">
                  <h5 class="post-title">Vital Villas</h5>
                  <p class="location">
                  ...
                  <div class="bathroom post-details">
                    <p>
                      <i class="icon-hl-bathroom"></i><br>
                      <span class="bathroom-quantity">2</span><br>
                      Bathroom
                    </p>                    
                  </div>
                  ...
                  <div class="bedroom post-details">
                    <p>
                      <i class="icon-hl-bed"></i><br>
                      <span class="rooms-quantity">2</span><br>
                      Bedroom 
                    </p>
                  ...
                  <div class="space post-details">
                    <p>
                      <i class="icon-hl-resize"></i><br>
                      <span class="space-measurement">120 sq ft</span><br>
                      Area
                    </p>       
                  </div>
                  ...
                  <div class="category post-details">
                    <p>
                      <span class="category">Home</span><br>
                      Category
                    </p>       
                  </div>
                  ...
                  <div class="post-details">
                    <p>
                      <span class="product-price">$954 890</span><br>
                      price
                    </p>       
                  </div>
                  </div>
